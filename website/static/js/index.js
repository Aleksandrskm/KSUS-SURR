    ...
    else
    {
      ...
      if (document.querySelector('.duplex-checkbox').checked) {
          postOcFrREs(result.satellite_id,document.querySelector('.duplex-checkbox').value,1,1)
            .then(respons=>{
             const randTime=getRandomNumber(60000,120000);
              ...
              document.getElementById('response3').innerHTML+=`<div>КСУС:  Начало сеанса связи: ${dateStartTime.toLocaleString()}</div>`;
              ...
              document.querySelector('.information_request').innerHTML+=`<div>КСУС:  Начало сеанса связи: ${dateStartTime.toLocaleString()}</div>`;
          ...
          if (!valueAbonent) {
            valueAbonent+=1;
             ...
             document.getElementById('response3').innerHTML+=`<div>КСУС:  Прогнозируемая продолжительность сеанса ,сек: ${time}</div>`;
             const dataSession={
          ...
          postActiveSession(dataSession).then((responses)=>{
            const timer=setTimeout(function(){
              postRelaeseFrRes(respons.Nomera_zanyatyih_yacheek,result.satellite_id).then(()=>{
                ...
                document.querySelector('.information_request').innerHTML+=`<div>КСУС: Запрос на освобождение частотного ресурса</div>`;
                document.querySelector('.information_request').innerHTML+=`<div>КСУС: Время запроса:${new Date().toLocaleString()}</div>`;
                ...
                document.getElementById('response3').innerHTML+=`<div>КСУС: Запрос на освобождение частотного ресурса</div>`;
                document.getElementById('response3').innerHTML+=`<div>КСУС: Время запроса:${new Date().toLocaleString()}</div>`;
          ...
          if (document.querySelector('h2').innerHTML=='Имитатор одиночных вызовов'){
            ...
            btnEnd.addEventListener('click',()=>{
             ...
             "Id_Seans_Rez": 1
                ...
                document.querySelector('.information_request').innerHTML+=` <br><div style="font-size: calc(1.2rem);">Завершение сеанса связи: </div>`;
                document.querySelector('.information_request').innerHTML+=`<div>КСУС: Запрос на освобождение частотного ресурса</div>`;
                document.querySelector('.information_request').innerHTML+=`<div>КСУС: Время запроса: ${time} секунд</div>`;
                document.querySelector('.information_request').innerHTML+=`<div>СУРР: Освобождения частотного ресурса подтверждена</div>`;
           ...
           console.log('1');
            document.getElementById('response3').innerHTML+=`<div>КСУС:  Прогнозируемая продолжительность сеанса ,сек: ${randTime/1000}</div>`;
            const dataSession={
              "ID_Zapros_Seans_Tek": 0,
              "Tlf1": String(numPhone),
              "ID_Abonent_T1": valueAbonent,
            ...
            btnEnd.addEventListener('click',()=>{
              ...
              postRelaeseFrRes(respons.Nomera_zanyatyih_yacheek,result.satellite_id).then(()=>{
                ...
                document.querySelector('.information_request').innerHTML+=`<div>КСУС: Запрос на освобождение частотного ресурса</div>`;
                  ...
                  document.getElementById('response3').innerHTML+=`<br><div style="
                  font-size: calc(1.2rem);">Завершение сеанса связи:</div>`;
                  document.getElementById('response3').innerHTML+=`<div>СУРР: КСУС: Запрос на освобождение частотного ресурса</div>`;
                  document.getElementById('response3').innerHTML+=` <div>КСУС: Время запроса:${new Date().toLocaleString()}</div>`;
                  document.getElementById('response3').innerHTML+=`<div>СУРР: Освобождения частотного ресурса подтверждена</div>`;
                  document.getElementById('response3').innerHTML+=`<div>СУРР: Время освобождения частотного ресурса: ${String(dataEndCall.toLocaleString())}</div>`;
                  const timeCall=Math.round(Number(dataEndCall-new Date(data.start_datetime_iso)/1000));
      ...
      // }
        ...
        postOcFrREs(result.satellite_id,document.querySelector('.simplex-checkbox').value,0,1).then(response=>{
          ...
          document.getElementById('response3').innerHTML+=`<div>КСУС:  Начало сеанса связи: ${dateStartTime.toLocaleString().toLocaleString()}</div>`;
          ...
          postActiveSession(dataSession).then((responses)=>{
            const timer=setTimeout(function(){
              postRelaeseFrRes(response.Nomera_zanyatyih_yacheek,result.satellite_id).then(()=>{
                document.querySelector('.information_request').innerHTML+=` <br><div style="font-size: calc(1.2rem);">Завершение сеанса связи: </div>`;
                document.querySelector('.information_request').innerHTML+=`<div>КСУС: Запрос на освобождение частотного ресурса</div>`;
                document.querySelector('.information_request').innerHTML+=`<div>КСУС: Время запроса: ${new Date().toLocaleString()} секунд</div>`;
                document.querySelector('.information_request').innerHTML+=`<div>СУРР: Освобождения частотного ресурса подтверждена</div>`;
                document.querySelector('.information_request').innerHTML+=`<div>CУРР: Продолжительность вызова ${time} секунд</div>`;
                const dataEndCall=new Date();
                ...
                font-size: calc(1.2rem);">Завершение сеанса связи:</div>`;
                document.getElementById('response3').innerHTML+=`<div>КСУС: Запрос на освобождение частотного ресурса</div>`;
                document.getElementById('response3').innerHTML+=`<div>КСУС: Время запроса: ${new Date().toLocaleString()} секунд</div>`;
                document.getElementById('response3').innerHTML+=`<div>СУРР: Освобождения частотного ресурса подтверждена</div>`;
                document.getElementById('response3').innerHTML+=`<div>СУРР: Время освобождения частотного ресурса: ${String(dataEndCall.toLocaleString())}</div>`;
                addArchivalSession(responses.ID,String(dataEndCall),time,time,1);
              });  
            ...
            if(document.querySelector('h2').innerHTML=='Имитатор одиночных вызовов'){
              ...
              btnEnd.addEventListener('click',()=>{
                ...
                document.querySelector('.information_request').innerHTML+=`<div>КСУС: Время запроса: ${new Date().toLocaleString()} секунд</div>`;
                    ...
                    font-size: calc(1.2rem);">Завершение сеанса связи:</div>`;
                    document.getElementById('response3').innerHTML+=`<div>КСУС: Запрос на освобождение частотного ресурса</div>`;
                    document.getElementById('response3').innerHTML+=`<div>СУРР: КСУС: Время запроса:  ${(new Date().toLocaleString())}</div>`;
                    document.getElementById('response3').innerHTML+=`<div>СУРР: Освобождения частотного ресурса подтверждена</div>`;
                    document.getElementById('response3').innerHTML+=`<div>СУРР: Время освобождения частотного ресурса: ${String(dataEndCall.toLocaleString())}</div>`;
                    const timeCall=Math.round(Number(dataEndCall-new Date(data.start_datetime_iso)/1000));
                    addArchivalSession(responses.ID,String(dataEndCall),timeCall,timeCall,7);
      ...
      for (const [key, value] of Object.entries(data)) {
        if (typeof(value)!='object') {
          if (key=='start_datetime_iso') {
            ...
            document.getElementById('response3').innerHTML+=`<div>КСУС: Инициирование сеанса связи</div>`;
            createInformationRequest.innerHTML+=`<div>КСУС: Инициирование сеанса связи</div>`; 
            createInformationRequest.innerHTML+=`<div>КСУС:Время инициирования сеанса связи: ${new Date(value).toLocaleString()}</div>`; 
            document.getElementById('response3').innerHTML+=`<div>КСУС:Время инициирования сеанса связи: ${new Date(value).toLocaleString()}`;
            ...
            createInformationRequest.innerHTML+=`<div>КСУС: Минимальная продолжительность вызова, сек: ${value}</div>`;
            console.log(value);
          }
          else{
    ...
    for (const [key, value] of Object.entries(data)) {
      if (typeof(value)!='object') {
        if (key=='start_datetime_iso') {
          ...
          createInformationRequest.innerHTML+=`<div>КСУС:Время инициирования сеанса связи: ${new Date(value.toLocaleString())}</div>`;
          document.getElementById('response3').innerHTML+=`<div>КСУС: Инициирование сеанса связи</div>`;
          document.getElementById('response3').innerHTML+=`<br><div>КСУС:Время инициирования сеанса связи: ${new Date(value).toLocaleString()}` ;
          // const div=document.createElement('div');
          // div.textContent=`Время инициирования сеанса связи: ${value}`;
          // document.getElementById('long-res').after(div); 
        }
